...
%setup -q -n base64enc
pushd ..
cp -a base64enc buildavx2
popd
pushd ..
cp -a base64enc buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737132562
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/base64enc/libs/base64enc.so
/V4/usr/lib64/R/library/base64enc/libs/base64enc.so
